...
class BackupManager:
    ...
    def create_backup(self, description="Manual backup"):
        ...
        manifest = {
            ...
            "files_skipped": [{"item": item, "reason": reason} for item, reason in skipped],
        ...
        for backup_name in os.listdir(self.backup_root):
            ...
            if os.path.isdir(backup_path):
                try:
                    ...
                    backup_date = datetime.strptime(backup_name.split('_')[0], "%Y-%m-%d")
    ...
    def restore_backup(self, backup_name):
        ...
        print(f"\nHow this works:")
        print(f"  • Copies backup files to original locations")
        print(f"  • Overwrites existing files with backup versions")
        print(f"  • Files not in backup remain untouched")
        print(f"  • Directories are replaced completely")
        print()
        ...
        print(f"   Other files in your project remain unchanged.")
