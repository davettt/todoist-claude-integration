        ...
        if os.path.exists(filepath):
            ...
            try:
                ...
                if 'summary' in data:
                    ...
                    print(f"   Best work days: {len(summary.get('best_days_for_work', []))}")
                    print(f"   Focus time available: {summary.get('focus_time_available', 'N/A')} days")
                
            except Exception:
                print(f"   Status: File exists but couldn't read summary")
    ...
    while True:
        ...
        try:
            ...
            if choice == '1':
                ...
                run_script('calendar_event_manager.py', 'Processing calendar operations')
