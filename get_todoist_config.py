...
def save_configuration_data(projects, labels, sections):
    ...
    print("You can share this configuration with Claude for properly organized task files!")
...
def main():
    ...
    try:
        ...
        print(f"📊 Summary: {len(projects)} projects, {len(labels)} labels, {len(sections)} sections")
