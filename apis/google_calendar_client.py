...
class GoogleCalendarClient:
    ...
    def get_events(
        ...
        try:
            ...
            self.log_operation(
                "Fetched events", f"{len(events)} events from {calendar_id}"
            )
            return events
    ...
    def delete_event(
        self, calendar_id: str, event_id: str, event_summary: str = ""
    ) -> bool:
    ...
    def find_free_time(
        self, calendar_id: str, time_min: str, time_max: str, duration_minutes: int = 60
    ) -> List[Dict[str, Any]]:
